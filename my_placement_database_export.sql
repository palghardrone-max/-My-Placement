...
INSERT INTO [_cf_METADATA] VALUES (2, 4341);
...
-- Table: hrms_salary
DROP TABLE IF EXISTS [hrms_salary];
...
-- Table: hrms_staff
DROP TABLE IF EXISTS [hrms_staff];
...
DROP TABLE IF EXISTS [review_removal_requests];
